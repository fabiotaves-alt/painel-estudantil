...
class Subject(SubjectBase, TimestampMixin, table=True):
    ...
    id: int | None = Field(default=None, primary_key=True)
    semester_id: int | None = Field(default=None, foreign_key="semesters.id", nullable=False)
...
class ClassMeeting(ClassMeetingBase, TimestampMixin, table=True):
    ...
    id: int | None = Field(default=None, primary_key=True)
    subject_id: int | None = Field(default=None, foreign_key="subjects.id", nullable=False)
